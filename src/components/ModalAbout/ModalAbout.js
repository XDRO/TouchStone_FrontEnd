      ...
      <div>
        <div>
          ...
          <p className={`modal__text modal__text_${"about"}`}>
            ...
            culmination of my journey at TripleTen and is my final project
            before graduation. If you're curious about TripleTen, passionate
            about learning to code, or eager to enter the tech industry, feel
            free to explore more at:
            <a
          ...
          <p className={`modal__text modal__text_${"about"}`}>
            ...
            OpenAI API. If you're interested in harnessing the power of the
            OpenAI API for your projects, you can find comprehensive
            documentation here:
            <a
              className={`modal__link_${"about"}`}
          ...
          <p className={`modal__text modal__text_${"about"}`}>
            To dive deeper into this project, please visit my GitHub
            repositories: <br></br>
            <p className={`modal__text modal__text_${"about"}`}>
              Frontend repository:
              <a
